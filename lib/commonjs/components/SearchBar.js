...
function SearchBar(props, forwardedRef) {
  ...
  return /*#__PURE__*/_react.default.createElement(NativeSearchBar, _extends({
    ...
    obscureBackground: (0, _utils.parseBooleanToOptionalBooleanNativeProp)(props.obscureBackground),
    hideNavigationBar: (0, _utils.parseBooleanToOptionalBooleanNativeProp)(props.hideNavigationBar),
