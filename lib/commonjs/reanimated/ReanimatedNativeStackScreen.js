...
const ReanimatedNativeStackScreen = /*#__PURE__*/_react.default.forwardRef((props, ref) => {
  ...
  const translationY = (0, _reactNativeReanimated.useSharedValue)(dimensions.height);
  ...
  , _extends({
    ...
    onSheetTranslationReanimated: (0, _reactNativeReanimated.useEvent)(event => {
      ...
      if (event.transitioning) {
        translationY.value = _reactNative.Platform.OS === 'android' ? (0, _reactNativeReanimated.withTiming)(event.y, {
          duration: 300
        }) : (0, _reactNativeReanimated.withSpring)(event.y, SPRING_CONFIG);
      } else {
