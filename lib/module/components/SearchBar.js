...
function SearchBar(props, forwardedRef) {
  ...
  return /*#__PURE__*/React.createElement(NativeSearchBar, _extends({
    ...
    obscureBackground: parseBooleanToOptionalBooleanNativeProp(props.obscureBackground),
    hideNavigationBar: parseBooleanToOptionalBooleanNativeProp(props.hideNavigationBar),
